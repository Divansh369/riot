...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('fs'), require('esprima')) :
  typeof define === 'function' && define.amd ? define(['exports', 'fs', 'esprima'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.compiler = {}, global.fs, global.esprima));
})(this, (function (exports, require$$1$2, require$$1$1) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  function requireEsprima () {
  	...
  	function parse(source, options) {
  	    var comments = [];
  	    var ast = require$$1$1.parse(source, {
  	        loc: true,
  	        locations: true,
  	        comment: true,
  	        onComment: comments,
  ...
  function requireParser () {
  	...
  	function parse(source, options) {
  	    ...
  	    var tokens = Array.isArray(ast.tokens)
  	        ? ast.tokens
  	        : require$$1$1.tokenize(sourceWithoutTabs, {
  	            loc: true,
  	        });
